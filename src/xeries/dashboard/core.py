...
from xeries.dashboard.components.causal import CausalComponent
from xeries.dashboard.components.error_analysis import ErrorAnalysisComponent
from xeries.dashboard.components.interactions import InteractionComponent
from xeries.dashboard.components.interpretability import InterpretabilityComponent
from xeries.dashboard.report import show_html_report, write_html_report
...
class Dashboard:
    ...
    def generate_report(self, path: str | Path, title: str = "Xeries Dashboard Report") -> Path:
    ...
    def generate_scorecard(self, path: str | Path) -> Path:
        ...
        return self.generate_report(path=path, title="Xeries Scorecard")

    def show(self, title: str = "Xeries Dashboard Report") -> Path:
